...
{/* left */}
<div id='contact' className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4' >
    <div className='lg:p-4 h-full' >
        <div>
        <img className='rounded-xl hover:scale-105 ease-in duration-300 mx-auto' src="/neoPhone.jpg" alt="Neo Phone" />
        </div>
        <div>
    ...
    <div className='p-4' >
            ...
            <form>
                <div className='grid md:grid-cols-2 gap-4 w-full py-2' >
                    ...
                    <div className='flex flex-col' >
                        <label className='uppercase text-sm py-2' >Phone -Optional-</label>
                        <input  className='border-2 rounded-lg p-3 flex border-gray-300' type="text" />
                    </div>
                </div>
